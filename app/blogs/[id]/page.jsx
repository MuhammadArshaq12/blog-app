...
const BlogPostPage = ({ params }) => {
  ...
  return (data ? (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-6 px-4 md:px-12 lg:px-28 shadow-lg">
        <div className="flex justify-between items-center">
          <Link href='/' className="transform hover:scale-105 transition-transform duration-200">
            <Image src={assets.logo} width={180} alt="Logo" className="w-[130px] sm:w-auto brightness-0 invert" />
          </Link>
        </div>
      </div>
